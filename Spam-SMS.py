...
print ("***************************************************************")
print ("  FB : https://www.facebook.com/profile.php?id=100070267970599  ")
print ("              กดติดตามช่อง : LTEMX2 ด้วยไอ้สัส                       ")
print ("         66แทนเลข0ตัวอย่าง : 66854631326                        ")
print ("***************************************************************")
print ("                   python Spam-SMS.py                 ")
print ("")
print ("")
numbers = input("ใส่เบอร์ : ")
